...
// import { UserContext } from '../context/user.context'; // Added UserContext import
// import axios from '../config/axios'; // Added axios import
...
//   const { user, clearUser } = useContext(UserContext); // Using UserContext
...
//   // Handle logout (from old code, adapted)
//   const handleLogout = async () => {
//     try {
//       await axios.get('/users/logout', { withCredentials: true });
//       clearUser();
//       navigate('/'); // Navigate to home/landing after logout
//     } catch (error) {
...
//       opacity: 1,
//       transition: {
//         delay: (typeof i === 'number' ? i : 0) * (reducedMotion ? 0 : 0.1), // Ensure i is a number
...
//     visible: (i = 0) => ({ // Added default for i
//         opacity: 1, 
//         y: 0, 
//         transition: { 
//             delay: (typeof i === 'number' ? i : 0) * (reducedMotion ? 0 : 0.05), // Stagger delay for letters
...
//             style={{ y: heroImageY }} // Apply parallax effect to the editor visualization
...
//             <motion.button
//               variants={buttonAnimation} whileHover="hover" whileTap="tap"
//               onClick={() => navigate('/demo')} // Assuming a /demo page
