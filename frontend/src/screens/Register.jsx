    ...
    function submitHandler(e) {
        ...
        axios.post('/users/register', {
            ...
            if (res.data && res.data.user) {
                ...
                console.log('User registered, redirecting immediately to home');
                ...
                setError('Registration successful but user data is missing. Please try again.');
            }
        }).catch((err) => {
            ...
            if (err.code === 'ECONNABORTED') {
                ...
                if (status === 409 || errorMessage?.includes('duplicate key') || errorMessage?.includes('already exists')) {
